...
public class HouseHolderGroup extends BaseClass {
	...
	private WebElement HHViewPlans;
	...
	@FindBy(xpath="//div[@id='Plans_Modal_CfDJ8HIYX4nAKWdBs9YPHdYG4j06dfyUufYpPRVlMG9FoidDPToRU63FDBcWzdNxn-7RhHdmblMPzEOTJUCV_qPNjf9_TpHHGma6PLUimvxM24iq0T1-IzrTpDzNvB_geG1S7Q']//button[@id='ViewPlans']")
	private WebElement HHViewPlansNextbutton;
	
	@FindBy(xpath="//div[@id='Plans_Modal_CfDJ8HIYX4nAKWdBs9YPHdYG4j2RefSTX0OS0xD6hmPJQC4rjVxFECrQFFSBUovwZyb1EvllBG-s_jPu66MZy-Rym-AEeUCBZIb1Vhr0a2iB3xGA8szHkdNdxGHeLcopCYE_Ng']//button[@id='modal_close']")
	...
	@FindBy(xpath="//div[@class='icheckbox_square-green hover']")
	...
	@FindBy(xpath="//button[normablize-space()='OK']")
	...
	public WebElement getHHViewPlans() {
		return HHViewPlans;
	}
...
//=================================Property Details================================
	...
	@FindBy(xpath="//div[4]//div[1]//div[1]//div[2]//div[2]//a[1]")
	...
	//-------------------------------------------------------Newly add------------------------------------
		...
		private WebElement yes_btn;
			...
			@FindBy(xpath="//*[@id='tenure_id']")
			private WebElement HHViewPlansTenure;
			
			public WebElement getHHViewPlansTenure() {
				return HHViewPlansTenure;
			}
	

	public HouseHolderGroup() {
